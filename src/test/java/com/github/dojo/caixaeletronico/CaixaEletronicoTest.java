...
public class CaixaEletronicoTest {
    ...
    public void sacar_valor_100() {
        int valorSaque = 100;
        Assert.assertArrayEquals(new Integer[] { 100 }, caixaEletronico.sacar(valorSaque).toArray(new Integer[0]));
    }

    @Test()
    public void sacar_valor_50() {
        int valorSaque = 50;
        Assert.assertArrayEquals(new Integer[] { 50 }, caixaEletronico.sacar(valorSaque).toArray(new Integer[0]));
    }   

    @Test()
    public void sacar_valor_20() {
        int valorSaque = 20;
        Assert.assertArrayEquals(new Integer[] { 20 }, caixaEletronico.sacar(valorSaque).toArray(new Integer[0]));
    }
    
    @Test()
    public void sacar_valor_10() {
        int valorSaque = 10;
        Assert.assertArrayEquals(new Integer[] { 10 }, caixaEletronico.sacar(valorSaque).toArray(new Integer[0]));
    }  
